...
const ACTIVITIES = [
  ...
  },
  {
    ...
    link: null,
    tags: { outdoors: true, indoors: false, water: true, kidFriendly: false, food: false, liveMusic: false, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["hot"],
    timeOfDay: ["morning", "afternoon"],
  ...
  // ============================================================
  {
    id: "zilker-park",
    name: "Zilker Park",
    description: "Austin's 350-acre crown jewel park sits right along Barton Creek and Lady Bird Lake. There's an enormous great lawn where people throw frisbees, fly kites, and spread out blankets. The Zilker Botanical Garden is tucked into the northeast corner ($5 entry, worth it for the Japanese garden). The Zilker Zephyr miniature train takes kids on a 25-minute ride along the creek — a toddler favorite. There are multiple playgrounds, including the big Zilker playground near the pool. The Barton Creek Greenbelt trailhead starts at the south end of the park, connecting to miles of hiking trails. On a nice Saturday, this park is Austin at its best — soccer games, drum circles, dog walkers, picnic blankets everywhere. Parking is the main challenge. The lot fills up fast on weekends; consider parking on Stratford Drive and walking in, or biking down the Butler Trail. During ACL Festival (October) and other events, portions of the park close to the public. The rest of the year it's wide open and free.",
    link: "https://www.austintexas.gov/department/zilker-metropolitan-park",
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: false, hiking: true, playground: true },
    weather: ["cool", "any"],
    timeOfDay: ["morning", "afternoon"],
    neighborhood: "South Austin / Zilker",
    cost: "free",
  ...
  },
  {
    ...
    link: null,
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: true, hiking: true, playground: false },
    weather: ["cool", "any"],
    timeOfDay: ["morning", "afternoon", "evening"],
    neighborhood: "Downtown / South Austin",
    cost: "free",
  ...
  // ============================================================
  {
    ...
    tags: { outdoors: false, indoors: true, water: false, kidFriendly: true, food: true, liveMusic: false, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["hot", "any"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: true, water: false, kidFriendly: true, food: true, liveMusic: false, comedy: false, sports: false, hiking: false, playground: true },
  ...
  },
  {
    ...
    tags: { outdoors: false, indoors: true, water: false, kidFriendly: false, food: true, liveMusic: true, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["hot", "cool", "any"],
    timeOfDay: ["evening"],
  ...
  // ============================================================
  {
    ...
    link: null,
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: false, hiking: false, playground: true },
    weather: ["cool", "any"],
    timeOfDay: ["morning", "afternoon"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: true, liveMusic: false, comedy: false, sports: false, hiking: false, playground: true },
    weather: ["cool", "any"],
    timeOfDay: ["morning", "afternoon", "evening"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: true, water: false, kidFriendly: true, food: true, liveMusic: false, comedy: false, sports: true, hiking: false, playground: false },
    weather: ["hot", "cool", "any"],
    timeOfDay: ["afternoon", "evening"],
