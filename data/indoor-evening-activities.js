...
const INDOOR_EVENING_ACTIVITIES = [
  ...
  // ============================================================
  {
    ...
    tags: { outdoors: false, indoors: true, water: false, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["hot", "any"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: true, water: false, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["cool", "any"],
    timeOfDay: ["morning", "afternoon"],
  ...
  },
  {
    ...
    description: "Austin's contemporary art museum operates two locations: the downtown Jones Center on Congress Avenue and the Laguna Gloria lakeside campus. Laguna Gloria is the star — a 1916 Italianate villa on 14 acres of Lake Austin shoreline with an outdoor sculpture park and walking trails through the grounds. The Art School at Laguna Gloria offers drop-in classes and workshops. The Jones Center downtown hosts rotating exhibitions of contemporary and modern art across multiple floors. Admission covers both locations: $12 for adults, $10 for students, free for members and kids under 18. Free on Tuesdays. Laguna Gloria is especially magical — sculptures placed throughout the grounds, views of the lake, peacocks wandering the gardens. Budget 60-90 minutes for each location. The Laguna Gloria grounds are stroller-friendly but hilly in parts. Parking at Laguna Gloria is in a small lot that fills on weekends — arrive early or take the shuttle from downtown on event days. The combination of serious contemporary art in a natural lakeside setting is unique to Austin and worth prioritizing on a nice day.",
  ...
  // ============================================================
  {
    ...
    link: null,
    tags: { outdoors: false, indoors: true, water: false, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: true, hiking: false, playground: false },
    weather: ["hot", "any"],
  ...
  },
  {
    ...
    tags: { outdoors: false, indoors: true, water: false, kidFriendly: false, food: false, liveMusic: false, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["hot", "any"],
    timeOfDay: ["afternoon", "evening"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: true, hiking: false, playground: false },
    weather: ["cool", "any"],
    timeOfDay: ["afternoon", "evening"],
    neighborhood: "South Austin / Zilker",
    cost: "cheap",
  ...
  // ============================================================
  {
    ...
    tags: { outdoors: false, indoors: true, water: false, kidFriendly: false, food: false, liveMusic: false, comedy: true, sports: false, hiking: false, playground: false },
    weather: ["hot", "cool", "any"],
    timeOfDay: ["evening"],
  ...
  },
  {
    ...
    tags: { outdoors: false, indoors: true, water: false, kidFriendly: false, food: true, liveMusic: false, comedy: true, sports: false, hiking: false, playground: false },
    weather: ["hot", "cool", "any"],
    timeOfDay: ["evening"],
  ...
  // ============================================================
  {
    ...
    tags: { outdoors: false, indoors: true, water: false, kidFriendly: false, food: false, liveMusic: true, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["hot", "cool", "any"],
    timeOfDay: ["evening"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: true, water: false, kidFriendly: false, food: true, liveMusic: true, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["cool", "any"],
    timeOfDay: ["evening"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: true, water: false, kidFriendly: false, food: false, liveMusic: true, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["cool", "any"],
    timeOfDay: ["evening"],
    neighborhood: "Red River / Downtown",
    cost: "cheap",
  ...
  // ============================================================
  {
    ...
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["cool", "any"],
    timeOfDay: ["evening"],
    neighborhood: "Mueller / Northeast Austin",
    cost: "cheap",
  ...
  // ============================================================
  {
    ...
    tags: { outdoors: true, indoors: true, water: false, kidFriendly: true, food: true, liveMusic: false, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["hot", "cool", "any"],
    timeOfDay: ["afternoon", "evening"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: true, liveMusic: false, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["hot", "cool", "any"],
    timeOfDay: ["morning", "afternoon"],
    neighborhood: "East Austin",
    cost: "moderate",
  ...
  {
    id: "hope-farmers-market",
    name: "HOPE Farmers Market (Sunday)",
    description: "A vibrant Sunday morning farmers market in East Austin at Plaza Saltillo (East 5th and Comal). Smaller and more neighborhood-y than Mueller but with equally good vendors. The prepared food scene is strong — you'll find excellent breakfast tacos, pastries, fresh juice, and coffee. The produce vendors are local small farms selling seasonal Texas vegetables, which teaches you what actually grows here (hint: lots of peppers, tomatoes in summer, greens in winter). Live music, a dog-friendly atmosphere, and a diverse East Austin crowd. Open Sundays 9 AM to 1 PM. The Plaza Saltillo location has the MetroRail stop right there if you want to be car-free. Parking in surrounding lots and streets. HOPE stands for House of Plenty of Everything, which is accurate. The vibe is more bohemian than Mueller — more artists, more food experimentation, more East Austin energy. Kids are welcome and the atmosphere is relaxed. Combine with brunch at one of the many excellent East Austin restaurants nearby. A great low-key Sunday morning activity that costs nothing to browse and $10-20 to eat well.",
    link: "https://www.hopefarmersmarket.org",
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: true, liveMusic: false, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["cool", "any"],
    timeOfDay: ["morning"],
    neighborhood: "East Austin",
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: true, liveMusic: false, comedy: false, sports: true, hiking: false, playground: true },
    weather: ["cool", "any"],
    timeOfDay: ["evening"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: true, liveMusic: false, comedy: false, sports: true, hiking: false, playground: false },
    weather: ["cool", "any"],
    timeOfDay: ["evening"],
    neighborhood: "North Austin / Domain",
    cost: "moderate",
