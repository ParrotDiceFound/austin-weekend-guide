...
const PARKS_OUTDOOR_ACTIVITIES = [
  ...
  // ============================================================
  {
    ...
    tags: { outdoors: true, indoors: false, water: true, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: false, hiking: false, playground: true },
    weather: ["cool", "any"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: false, water: true, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: true, hiking: false, playground: true },
    weather: ["hot", "any"],
    timeOfDay: ["morning", "afternoon"],
  ...
  },
  {
    ...
    link: null,
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: true, hiking: true, playground: true },
    weather: ["cool", "any"],
    timeOfDay: ["morning", "afternoon"],
  ...
  },
  {
    ...
    link: null,
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: true, hiking: false, playground: true },
    weather: ["cool", "any"],
    timeOfDay: ["morning", "afternoon"],
  ...
  },
  {
    ...
    link: null,
    tags: { outdoors: true, indoors: false, water: true, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: false, hiking: true, playground: true },
  ...
  // ============================================================
  {
    ...
    tags: { outdoors: true, indoors: false, water: true, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: false, hiking: true, playground: false },
    weather: ["hot", "cool", "any"],
    timeOfDay: ["morning", "afternoon"],
  ...
  },
  {
    ...
    link: "https://www.austintexas.gov/department/barton-creek-greenbelt",
    tags: { outdoors: true, indoors: false, water: true, kidFriendly: false, food: false, liveMusic: false, comedy: false, sports: false, hiking: true, playground: false },
    weather: ["hot", "cool"],
    timeOfDay: ["morning", "afternoon"],
  ...
  },
  {
    ...
    link: null,
    tags: { outdoors: true, indoors: false, water: true, kidFriendly: false, food: false, liveMusic: false, comedy: false, sports: true, hiking: true, playground: false },
    weather: ["cool", "any"],
    timeOfDay: ["morning", "afternoon"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: false, hiking: true, playground: false },
    weather: ["cool", "any"],
    timeOfDay: ["morning", "afternoon"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: false, food: false, liveMusic: false, comedy: false, sports: false, hiking: true, playground: false },
    weather: ["cool"],
    timeOfDay: ["morning"],
  ...
  // ============================================================
  {
    ...
    tags: { outdoors: true, indoors: false, water: true, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: false, hiking: false, playground: false },
    weather: ["hot"],
    timeOfDay: ["morning", "afternoon"],
  ...
  // ============================================================
  {
    ...
    tags: { outdoors: true, indoors: true, water: false, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: false, hiking: true, playground: false },
    weather: ["hot", "cool", "any"],
    timeOfDay: ["morning", "afternoon"],
    neighborhood: "South Austin / Zilker",
    cost: "free",
  ...
  {
    id: "metrobike-rental",
    name: "MetroBike (Austin Bike Share)",
    description: "Austin's public bike-share system (formerly B-cycle, now managed by Capital Metro) with stations throughout downtown, East Austin, South Congress, and the university area. Grab a bike from any station, ride to your destination, dock it at another station. Perfect for riding the Lady Bird Lake Trail, exploring South Congress, or getting between downtown spots without a car. Standard bikes and e-bikes available. Single rides start at a few dollars; day passes and monthly memberships are available for frequent riders. The e-bikes make the Lady Bird Lake loop (roughly 10 miles) genuinely pleasant even in warm weather and for people who aren't avid cyclists. Stations are dense enough in central Austin that you're usually within a couple blocks of one. The bikes are sturdy city bikes with baskets — not performance bikes, but perfectly good for cruising. The system works via app — download MetroBike, find a station, unlock a bike with your phone. Helmets are not provided, so bring your own or rent from a nearby shop. Great for visitors staying downtown who want to explore without driving. Kid trailers and child seats not available — this is an adult/older kid activity.",
    link: null,
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: false, food: false, liveMusic: false, comedy: false, sports: true, hiking: false, playground: false },
    weather: ["cool", "any"],
    timeOfDay: ["morning", "afternoon", "evening"],
  ...
  },
  {
    ...
    link: null,
    tags: { outdoors: true, indoors: false, water: true, kidFriendly: true, food: false, liveMusic: false, comedy: false, sports: true, hiking: false, playground: false },
    weather: ["cool", "any"],
    timeOfDay: ["morning", "afternoon"],
  ...
  },
  {
    ...
    tags: { outdoors: true, indoors: false, water: false, kidFriendly: true, food: true, liveMusic: false, comedy: false, sports: false, hiking: true, playground: true },
    weather: ["cool", "any"],
    timeOfDay: ["morning", "afternoon"],
